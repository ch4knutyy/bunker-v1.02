...
const apocalypsePhysicalThemeProfiles = Object.freeze({
	...
	'extreme-cold': Object.freeze({ lighting: 'cold-diffuse', air: 'condensed', contamination: 'frost', damage: 'weathered', visibility: 'softened', accent: 'steel-blue', intensity: .27, lightingIntensity: .2, contaminationIntensity: .13, visibilityReduction: .07, animationIntensity: .025 }),
	...
	'solar-flare': Object.freeze({ lighting: 'unstable-cold', air: 'static', contamination: 'electrical-noise', damage: 'systems', visibility: 'normal', accent: 'pale-electric', intensity: .27, lightingIntensity: .2, contaminationIntensity: .1, visibilityReduction: .04, animationIntensity: .05 }),
	...
	'machine-uprising': Object.freeze({ lighting: 'mechanical-cold', air: 'static', contamination: 'electrical-noise', damage: 'systems', visibility: 'normal', accent: 'cold-white', intensity: .24, lightingIntensity: .2, contaminationIntensity: .09, visibilityReduction: .03, animationIntensity: .045 }),
	...
	antimatter: Object.freeze({ lighting: 'cold-anomalous', air: 'unstable', contamination: 'none', damage: 'light', visibility: 'softened', accent: 'muted-violet-gray', intensity: .23, lightingIntensity: .17, contaminationIntensity: .06, visibilityReduction: .06, animationIntensity: .035 }),
