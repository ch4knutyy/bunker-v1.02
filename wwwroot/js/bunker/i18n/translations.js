// Responsibility: translation data for uk/en/ru UI strings.
// Loaded before game.js and localization.js as a classic synchronous script.
...
Object.assign(uiTranslations.uk, {
	...
	, gmTabGame: "Гра", gmTabPlayers: "Гравці", gmTabEvents: "Події", gmTabHistory: "Історія", gmTabTools: "Інструменти", gmTabDiagnostics: "Діагностика", gmTabRecovery: "Відновлення", gmTabOverview: "Огляд"
	, gmPrimaryFinishDiscussion: "Завершити фінальне обговорення", gmPrimaryStartGame: "Почати гру", gmPrimaryResumeTimer: "Продовжити таймер", gmPrimaryEndVoting: "Завершити голосування", gmPrimaryOpenThreat: "Відкрити керування загрозою", gmPrimaryEndRound: "Завершити раунд", gmPrimaryStartVoting: "Почати голосування", gmPrimaryNone: "Очікуйте наступного доступного кроку"
	, gmSummaryState: "Стан", gmSummaryPhase: "Фаза", gmSummaryRound: "Раунд", gmSummaryActive: "Активні", gmSummaryReadiness: "Готовність", gmSummaryTimer: "Таймер", gmSummaryVoting: "Голосування", gmSummaryThreat: "Загроза"
	, gmSummaryStateFull: "Стан гри", gmSummaryPhaseFull: "Поточна фаза", gmSummaryActiveFull: "Активні гравці", gmSummaryReadinessFull: "Готовність гравців", gmSummaryTimerFull: "Стан таймера", gmSummaryVotingFull: "Стан голосування", gmSummaryThreatFull: "Стан загрози", gmSummaryPostGameFull: "Завершення партії", gmSummaryVotes: "Подані голоси", gmSummaryTie: "Однаковий результат", gmOf: "із"
	, gmValueWaiting: "Очікування", gmValueLobby: "Лобі", gmValuePlaying: "Гра триває", gmValueVoting: "Голосування", gmValueFinished: "Партію завершено", gmValueRoundReveal: "Розкриття характеристик", gmValueRoundEnded: "Раунд завершено", gmValueThreat: "Активна загроза", gmValueDiscussion: "Обговорення", gmValueResults: "Підсумки гри", gmValueExtraInventory: "Додатковий інвентар", gmValuePreVotingReadyCheck: "Перевірка готовності", gmValueVotingResults: "Підсумки голосування", gmValueFinalDiscussion: "Фінальне обговорення", gmValueHostDecision: "Рішення ведучого", gmValueStoryRequested: "Історію запитано", gmValueStoryPreparation: "Підготовка історії", gmValueStoryPublished: "Історію опубліковано"
	, gmValueInactive: "Неактивне", gmValueActive: "Активне", gmValueCompleted: "Завершено", gmValueResolved: "Вирішено", gmValueHidden: "Приховано", gmValueThreatHidden: "Прихована", gmValueVisible: "Відкрито", gmValueRevealed: "Відкрито", gmValueStopped: "Зупинено", gmValueRunning: "Працює", gmValuePaused: "Призупинено", gmValueExpired: "Час вийшов", gmValueAborted: "Скасовано", gmValueSuccess: "Успішно", gmValueFailure: "Невдало", gmValueCollecting: "Очікує внесків", gmValueUnknown: "Невідомо", gmValueNone: "Немає"
	, gmRoleHost: "Ведучий", gmRoleDeveloper: "Розробник", gmRoleOmniscient: "GM-спостерігач", gmRoleTechnical: "Технічний GM", gmConnectionSynced: "Синхронізовано", gmPlayerOnline: "у мережі", gmPlayerOffline: "не в мережі", gmPlayerActive: "активний", gmPlayerEliminated: "вибув", gmPlayerCurrentTurn: "поточний хід", gmPlayerRevealed: "відкрито", gmYes: "Так", gmNo: "Ні", gmPlayerDataUnavailable: "Дані гравця недоступні."
	, gmRoundOperations: "Керування раундом", gmTimerOperations: "Керування таймером", gmVotingOperations: "Керування голосуванням", gmDeveloperToolbox: "Інструменти розробника", gmDeveloperToolboxHint: "Доступ визначається серверними правами розробника.", gmDeveloperSearch: "Пошук інструмента…", gmDeveloperDiagnostics: "Діагностика кімнати", gmDeveloperRoomEditor: "Сценарій, бункер і публічний стан", gmDeveloperOmniscient: "Режим GM-спостерігача"
	, gmEndRoundAction: "Перейти до наступного етапу", gmMarkAllReadyAction: "Позначити всіх готовими", gmStartVotingAction: "Почати голосування", gmEndVotingAction: "Завершити голосування", gmCancelVotingAction: "Скасувати голосування", gmTimerStartAction: "Запустити таймер", gmTimerPauseAction: "Призупинити таймер", gmTimerResumeAction: "Продовжити таймер", gmTimerRestartAction: "Перезапустити таймер", gmTimerSetAction: "Встановити час таймера", gmTimerStopAction: "Зупинити таймер"
	, gmStartEarlyVotingAction: "Почати дострокове голосування", gmEarlyVotingHint: "До третього раунду голосування є достроковим і необов’язковим.", gmVotingRevealRequirementHint: "Голосування можна почати після виконання вимоги розкриття.", gmConfirmEarlyVoting: "Почати дострокове голосування? Воно не є обов’язковим.", gmConfirmVoting: "Почати голосування?", gmVotingUnavailable: "Голосування зараз недоступне."
	, revealCreditsLabel: "Кредитів розкриття", revealRequirementSatisfiedByCredit: "Вимогу цього раунду виконано кредитом", revealCreditsAdded: "Нараховано кредитів розкриття: {count}", revealRequirementCompletedByForcedReveal: "Примусове розкриття виконало вимогу цього раунду.", revealCreditConsumed: "Кредит розкриття використано для вимоги нового раунду.", gmRevealCompleted: "Виконано", gmRevealCompletedByCredit: "Виконано кредитом", gmRevealPending: "Очікується розкриття"
	, gmRevealCreditTools: "Тестові кредити розкриття", gmRevealCreditToolsHint: "Явна developer-команда; кожна зміна потрапляє до audit і snapshot.", gmAddRevealCredit: "Додати 1 кредит", gmRemoveRevealCredit: "Зняти 1 кредит", gmRevealCreditAdjusted: "Кредити розкриття оновлено."
	, catalogPickerKicker: "Runtime-каталог", catalogPickerTitle: "Замінити значення", catalogPickerCategory: "Категорія", catalogPickerSearch: "Пошук", catalogPickerAction: "Дія", catalogPickerResults: "Каталог", catalogPickerPreview: "Попередній перегляд", catalogPickerSeverity: "Тяжкість", catalogPickerAdvanced: "Розширені операції", catalogPickerOperation: "Операція", catalogPickerTargetPlayer: "Другий гравець", catalogPickerPreviewAction: "Перевірити", catalogPickerApplyOperation: "Застосувати операцію", catalogPickerApply: "Застосувати", catalogPickerLoading: "Завантаження…", catalogPickerEmpty: "Записів не знайдено", catalogPickerError: "Не вдалося виконати операцію з каталогом", catalogPickerDangerConfirm: "Застосувати небезпечну операцію?"
	, catalogActionReplace: "Замінити", catalogActionAdd: "Додати", catalogActionRemove: "Видалити", catalogActionIssue: "Видати", catalogActionMarkUsed: "Позначити використаною", catalogActionRestoreUsed: "Відновити карту", catalogOperationExchange: "Обміняти", catalogOperationCopy: "Скопіювати", catalogOperationTransfer: "Передати", catalogOperationSteal: "Вкрасти", catalogOperationOppositeSex: "Змінити стать на протилежну"
	, gmPanelTitle: "Панель ведучого", gmClosePanel: "Закрити панель ведучого", gmPrimaryActionLabel: "Рекомендована дія", gmPanelLoading: "Завантаження панелі ведучого…", gmRetry: "Повторити", gmVotingAvailabilityHint: "Доступність голосування визначає поточний стан гри.", gmScenarioSituations: "Сценарні ситуації", gmSkipPendingChoice: "Пропустити поточний вибір", gmScenarioPrivacyHint: "Приватний власник карти не показується звичайному ведучому."
	, gmPanelConnectionUnavailable: "З’єднання із сервером ще не готове.", gmPanelRoomNotJoined: "Спочатку приєднайтеся до кімнати.", gmPanelRoomNotFound: "Поточну кімнату не знайдено.", gmPanelAccessDenied: "Немає доступу до панелі ведучого.", gmPanelStateFailed: "Сервер не зміг підготувати стан панелі.", gmPanelLoadFailed: "Не вдалося завантажити стан панелі.", gmPanelSyncFailed: "Не вдалося синхронізувати"
	, gmDiceResult: "Випало: {value}", gmDiceAlreadyRolled: "Кубик у цьому раунді вже кинуто", gmDiceUnavailable: "Кубик доступний після відкриття характеристик усіма активними гравцями", gmDiceFeedResult: "{player} кинув кубик у раунді {round}: {value}", gmPlayerSecondaryActions: "Додаткові дії", gmResyncPlayer: "Синхронізувати гравця", gmInspectConnection: "Перевірити connection", gmTransferHost: "Передати роль ведучого", gmHostTransferConfirm: "Передати роль ведучого?", gmHostTransferIneligible: "Цей гравець не може стати ведучим", gmHostTransferRestoreWarning: "Звичайне відновлення кімнати не повертає попереднього ведучого.", gmHideCharacteristic: "Сховати розкриту характеристику", gmHide: "Сховати", gmDangerousActions: "Небезпечні дії", gmKickPlayer: "Виключити з кімнати"
	...
	, gmQuickEvent: "Швидка подія", gmSendEvent: "Відправити подію", gmEventTextPlaceholder: "Текст події…", gmEventTextRequired: "Введіть текст події.", gmEventSendFailed: "Не вдалося відправити подію.", gmEventTypeInfo: "Інформація", gmEventTypeWarning: "Попередження", gmEventTypeDanger: "Небезпека", gmEventTypeSuccess: "Позитив", gmEventTypeCatastrophe: "Катастрофа"
	, gmEventTemplateEarthquake: "Землетрус", gmEventTemplateInfection: "Зараження", gmEventTemplateSurvivors: "Виживальці", gmEventTemplateGenerator: "Генератор", gmEventTemplateEarthquakeText: "Землетрус! Частина бункера пошкоджена.", gmEventTemplateInfectionText: "Загроза зараження! Потрібна дезінфекція.", gmEventTemplateSurvivorsText: "Зовнішні виживальці просять допомоги.", gmEventTemplateGeneratorText: "Генератор зламався! Світла немає."
	, gmActiveThreat: "Активна загроза", gmThreatNone: "Поточна загроза відсутня", gmThreatManage: "Керувати загрозою", gmThreatOperations: "Загроза", gmThreatSearch: "Пошук загрози…", gmThreatSelect: "Вибрати конкретну загрозу", gmThreatGenerateRare: "Згенерувати випадкову рідкісну", gmThreatGenerateText: "Згенерувати звичайну текстову"
	, gmResourceMonths: "Місяці ресурсу", gmAddFood: "+ Їжа", gmRemoveFood: "− Їжа", gmAddWater: "+ Вода", gmRemoveWater: "− Вода", gmBunkerConditions: "Умови бункера", gmApocalypseOperations: "Апокаліпсис", gmRegenerateBunker: "Новий бункер", gmRegenerateApocalypse: "Новий апокаліпсис", gmRegenerateBunkerConfirm: "Згенерувати новий бункер із канонічного каталогу?", gmRegenerateApocalypseConfirm: "Згенерувати новий апокаліпсис із канонічного каталогу?"
...
Object.assign(uiTranslations.en, {
	...
	, gmTabGame: "Game", gmTabPlayers: "Players", gmTabEvents: "Events", gmTabHistory: "History", gmTabTools: "Tools", gmTabDiagnostics: "Diagnostics", gmTabRecovery: "Recovery", gmTabOverview: "Overview"
	, gmPrimaryFinishDiscussion: "Finish final discussion", gmPrimaryStartGame: "Start game", gmPrimaryResumeTimer: "Resume timer", gmPrimaryEndVoting: "End voting", gmPrimaryOpenThreat: "Open threat controls", gmPrimaryEndRound: "End round", gmPrimaryStartVoting: "Start voting", gmPrimaryNone: "Wait for the next available step"
	, gmSummaryState: "State", gmSummaryPhase: "Phase", gmSummaryRound: "Round", gmSummaryActive: "Active", gmSummaryReadiness: "Readiness", gmSummaryTimer: "Timer", gmSummaryVoting: "Voting", gmSummaryThreat: "Threat"
	, gmSummaryStateFull: "Game state", gmSummaryPhaseFull: "Current phase", gmSummaryActiveFull: "Active players", gmSummaryReadinessFull: "Player readiness", gmSummaryTimerFull: "Timer status", gmSummaryVotingFull: "Voting status", gmSummaryThreatFull: "Threat status", gmSummaryPostGameFull: "Game completion", gmSummaryVotes: "Votes cast", gmSummaryTie: "Tied result", gmOf: "of"
	, gmValueWaiting: "Waiting", gmValueLobby: "Lobby", gmValuePlaying: "Game in progress", gmValueVoting: "Voting", gmValueFinished: "Game completed", gmValueRoundReveal: "Revealing characteristics", gmValueRoundEnded: "Round completed", gmValueThreat: "Active threat", gmValueDiscussion: "Discussion", gmValueResults: "Game results", gmValueExtraInventory: "Extra inventory", gmValuePreVotingReadyCheck: "Readiness check", gmValueVotingResults: "Voting results", gmValueFinalDiscussion: "Final discussion", gmValueHostDecision: "Host decision", gmValueStoryRequested: "Story requested", gmValueStoryPreparation: "Story preparation", gmValueStoryPublished: "Story published"
	, gmValueInactive: "Inactive", gmValueActive: "Active", gmValueCompleted: "Completed", gmValueResolved: "Resolved", gmValueHidden: "Hidden", gmValueThreatHidden: "Hidden", gmValueVisible: "Visible", gmValueRevealed: "Revealed", gmValueStopped: "Stopped", gmValueRunning: "Running", gmValuePaused: "Paused", gmValueExpired: "Time expired", gmValueAborted: "Cancelled", gmValueSuccess: "Successful", gmValueFailure: "Failed", gmValueCollecting: "Awaiting contributions", gmValueUnknown: "Unknown", gmValueNone: "None"
	, gmRoleHost: "Host", gmRoleDeveloper: "Developer", gmRoleOmniscient: "Observer GM", gmRoleTechnical: "Technical GM", gmConnectionSynced: "Synchronized", gmPlayerOnline: "online", gmPlayerOffline: "offline", gmPlayerActive: "active", gmPlayerEliminated: "eliminated", gmPlayerCurrentTurn: "current turn", gmPlayerRevealed: "revealed", gmYes: "Yes", gmNo: "No", gmPlayerDataUnavailable: "Player data is unavailable."
	, gmRoundOperations: "Round controls", gmTimerOperations: "Timer controls", gmVotingOperations: "Voting controls", gmDeveloperToolbox: "Developer tools", gmDeveloperToolboxHint: "Access is determined by server-provided developer permissions.", gmDeveloperSearch: "Search tools…", gmDeveloperDiagnostics: "Room diagnostics", gmDeveloperRoomEditor: "Scenario, bunker, and public state", gmDeveloperOmniscient: "Observer GM mode"
	, gmEndRoundAction: "Continue to the next stage", gmMarkAllReadyAction: "Mark everyone ready", gmStartVotingAction: "Start voting", gmEndVotingAction: "End voting", gmCancelVotingAction: "Cancel voting", gmTimerStartAction: "Start timer", gmTimerPauseAction: "Pause timer", gmTimerResumeAction: "Resume timer", gmTimerRestartAction: "Restart timer", gmTimerSetAction: "Set timer duration", gmTimerStopAction: "Stop timer"
	, gmStartEarlyVotingAction: "Start early voting", gmEarlyVotingHint: "Voting before round three is early and optional.", gmVotingRevealRequirementHint: "Voting can start after the reveal requirement is completed.", gmConfirmEarlyVoting: "Start early voting? It is optional.", gmConfirmVoting: "Start voting?", gmVotingUnavailable: "Voting is currently unavailable."
	, revealCreditsLabel: "Reveal credits", revealRequirementSatisfiedByCredit: "This round's requirement was completed by a credit", revealCreditsAdded: "Reveal credits added: {count}", revealRequirementCompletedByForcedReveal: "The forced reveal completed this round's requirement.", revealCreditConsumed: "A reveal credit completed the new round requirement.", gmRevealCompleted: "Completed", gmRevealCompletedByCredit: "Completed by credit", gmRevealPending: "Awaiting reveal"
	, gmRevealCreditTools: "Test reveal credits", gmRevealCreditToolsHint: "Explicit developer command; every change is audited and snapshotted.", gmAddRevealCredit: "Add 1 credit", gmRemoveRevealCredit: "Remove 1 credit", gmRevealCreditAdjusted: "Reveal credits updated."
	, catalogPickerKicker: "Runtime catalog", catalogPickerTitle: "Replace value", catalogPickerCategory: "Category", catalogPickerSearch: "Search", catalogPickerAction: "Action", catalogPickerResults: "Catalog", catalogPickerPreview: "Preview", catalogPickerSeverity: "Severity", catalogPickerAdvanced: "Advanced operations", catalogPickerOperation: "Operation", catalogPickerTargetPlayer: "Second player", catalogPickerPreviewAction: "Validate", catalogPickerApplyOperation: "Apply operation", catalogPickerApply: "Apply", catalogPickerLoading: "Loading…", catalogPickerEmpty: "No records found", catalogPickerError: "Catalog operation failed", catalogPickerDangerConfirm: "Apply the dangerous operation?"
	, catalogActionReplace: "Replace", catalogActionAdd: "Add", catalogActionRemove: "Remove", catalogActionIssue: "Issue", catalogActionMarkUsed: "Mark used", catalogActionRestoreUsed: "Restore card", catalogOperationExchange: "Exchange", catalogOperationCopy: "Copy", catalogOperationTransfer: "Transfer", catalogOperationSteal: "Steal", catalogOperationOppositeSex: "Set opposite sex"
	, gmPanelTitle: "Host panel", gmClosePanel: "Close host panel", gmPrimaryActionLabel: "Recommended action", gmPanelLoading: "Loading host panel…", gmRetry: "Retry", gmVotingAvailabilityHint: "Voting availability is determined by the current game state.", gmScenarioSituations: "Scenario situations", gmSkipPendingChoice: "Skip current choice", gmScenarioPrivacyHint: "A card's private owner is not shown to the regular host."
	, gmPanelConnectionUnavailable: "The server connection is not ready yet.", gmPanelRoomNotJoined: "Join a room first.", gmPanelRoomNotFound: "The current room was not found.", gmPanelAccessDenied: "You do not have access to the host panel.", gmPanelStateFailed: "The server could not prepare the panel state.", gmPanelLoadFailed: "Could not load the panel state.", gmPanelSyncFailed: "Synchronization failed"
	, gmDiceResult: "Rolled: {value}", gmDiceAlreadyRolled: "The die has already been rolled this round", gmDiceUnavailable: "The die is available after every active player reveals a characteristic", gmDiceFeedResult: "{player} rolled the die in round {round}: {value}", gmPlayerSecondaryActions: "Additional actions", gmResyncPlayer: "Resync player", gmInspectConnection: "Inspect connection", gmTransferHost: "Transfer host role", gmHostTransferConfirm: "Transfer the host role?", gmHostTransferIneligible: "This player cannot become the host", gmHostTransferRestoreWarning: "A normal room restore does not restore the previous host.", gmHideCharacteristic: "Hide revealed characteristic", gmHide: "Hide", gmDangerousActions: "Dangerous actions", gmKickPlayer: "Kick from room"
	...
	, gmQuickEvent: "Quick event", gmSendEvent: "Send event", gmEventTextPlaceholder: "Event text…", gmEventTextRequired: "Enter event text.", gmEventSendFailed: "Could not send the event.", gmEventTypeInfo: "Information", gmEventTypeWarning: "Warning", gmEventTypeDanger: "Danger", gmEventTypeSuccess: "Positive", gmEventTypeCatastrophe: "Catastrophe"
	, gmEventTemplateEarthquake: "Earthquake", gmEventTemplateInfection: "Infection", gmEventTemplateSurvivors: "Survivors", gmEventTemplateGenerator: "Generator", gmEventTemplateEarthquakeText: "Earthquake! Part of the bunker is damaged.", gmEventTemplateInfectionText: "Infection risk! Disinfection is required.", gmEventTemplateSurvivorsText: "Survivors outside are asking for help.", gmEventTemplateGeneratorText: "The generator is broken! There is no power."
	, gmActiveThreat: "Active threat", gmThreatNone: "There is no active threat", gmThreatManage: "Manage threat", gmThreatOperations: "Threat", gmThreatSearch: "Search threats…", gmThreatSelect: "Select a specific threat", gmThreatGenerateRare: "Generate a random rare threat", gmThreatGenerateText: "Generate a standard text threat"
	, gmResourceMonths: "Resource months", gmAddFood: "+ Food", gmRemoveFood: "− Food", gmAddWater: "+ Water", gmRemoveWater: "− Water", gmBunkerConditions: "Bunker conditions", gmApocalypseOperations: "Apocalypse", gmRegenerateBunker: "New bunker", gmRegenerateApocalypse: "New apocalypse", gmRegenerateBunkerConfirm: "Generate a new bunker from the canonical catalog?", gmRegenerateApocalypseConfirm: "Generate a new apocalypse from the canonical catalog?"
...
Object.assign(uiTranslations.ru, {
	...
	, gmTabGame: "Игра", gmTabPlayers: "Игроки", gmTabEvents: "События", gmTabHistory: "История", gmTabTools: "Инструменты", gmTabDiagnostics: "Диагностика", gmTabRecovery: "Восстановление", gmTabOverview: "Обзор"
	, gmPrimaryFinishDiscussion: "Завершить финальное обсуждение", gmPrimaryStartGame: "Начать игру", gmPrimaryResumeTimer: "Продолжить таймер", gmPrimaryEndVoting: "Завершить голосование", gmPrimaryOpenThreat: "Открыть управление угрозой", gmPrimaryEndRound: "Завершить раунд", gmPrimaryStartVoting: "Начать голосование", gmPrimaryNone: "Ожидайте следующего доступного шага"
	, gmSummaryState: "Состояние", gmSummaryPhase: "Фаза", gmSummaryRound: "Раунд", gmSummaryActive: "Активные", gmSummaryReadiness: "Готовность", gmSummaryTimer: "Таймер", gmSummaryVoting: "Голосование", gmSummaryThreat: "Угроза"
	, gmSummaryStateFull: "Состояние игры", gmSummaryPhaseFull: "Текущая фаза", gmSummaryActiveFull: "Активные игроки", gmSummaryReadinessFull: "Готовность игроков", gmSummaryTimerFull: "Состояние таймера", gmSummaryVotingFull: "Состояние голосования", gmSummaryThreatFull: "Состояние угрозы", gmSummaryPostGameFull: "Завершение партии", gmSummaryVotes: "Поданные голоса", gmSummaryTie: "Одинаковый результат", gmOf: "из"
	, gmValueWaiting: "Ожидание", gmValueLobby: "Лобби", gmValuePlaying: "Игра продолжается", gmValueVoting: "Голосование", gmValueFinished: "Партия завершена", gmValueRoundReveal: "Раскрытие характеристик", gmValueRoundEnded: "Раунд завершён", gmValueThreat: "Активная угроза", gmValueDiscussion: "Обсуждение", gmValueResults: "Итоги игры", gmValueExtraInventory: "Дополнительный инвентарь", gmValuePreVotingReadyCheck: "Проверка готовности", gmValueVotingResults: "Итоги голосования", gmValueFinalDiscussion: "Финальное обсуждение", gmValueHostDecision: "Решение ведущего", gmValueStoryRequested: "История запрошена", gmValueStoryPreparation: "Подготовка истории", gmValueStoryPublished: "История опубликована"
	, gmValueInactive: "Неактивно", gmValueActive: "Активно", gmValueCompleted: "Завершено", gmValueResolved: "Решено", gmValueHidden: "Скрыто", gmValueThreatHidden: "Скрыта", gmValueVisible: "Открыто", gmValueRevealed: "Открыто", gmValueStopped: "Остановлен", gmValueRunning: "Работает", gmValuePaused: "Приостановлен", gmValueExpired: "Время истекло", gmValueAborted: "Отменено", gmValueSuccess: "Успешно", gmValueFailure: "Неудачно", gmValueCollecting: "Ожидает вкладов", gmValueUnknown: "Неизвестно", gmValueNone: "Нет"
	, gmRoleHost: "Ведущий", gmRoleDeveloper: "Разработчик", gmRoleOmniscient: "GM-наблюдатель", gmRoleTechnical: "Технический GM", gmConnectionSynced: "Синхронизировано", gmPlayerOnline: "в сети", gmPlayerOffline: "не в сети", gmPlayerActive: "активен", gmPlayerEliminated: "выбыл", gmPlayerCurrentTurn: "текущий ход", gmPlayerRevealed: "открыто", gmYes: "Да", gmNo: "Нет", gmPlayerDataUnavailable: "Данные игрока недоступны."
	, gmRoundOperations: "Управление раундом", gmTimerOperations: "Управление таймером", gmVotingOperations: "Управление голосованием", gmDeveloperToolbox: "Инструменты разработчика", gmDeveloperToolboxHint: "Доступ определяется серверными правами разработчика.", gmDeveloperSearch: "Поиск инструмента…", gmDeveloperDiagnostics: "Диагностика комнаты", gmDeveloperRoomEditor: "Сценарий, бункер и публичное состояние", gmDeveloperOmniscient: "Режим GM-наблюдателя"
	, gmEndRoundAction: "Перейти к следующему этапу", gmMarkAllReadyAction: "Отметить всех готовыми", gmStartVotingAction: "Начать голосование", gmEndVotingAction: "Завершить голосование", gmCancelVotingAction: "Отменить голосование", gmTimerStartAction: "Запустить таймер", gmTimerPauseAction: "Приостановить таймер", gmTimerResumeAction: "Продолжить таймер", gmTimerRestartAction: "Перезапустить таймер", gmTimerSetAction: "Установить время таймера", gmTimerStopAction: "Остановить таймер"
	, gmStartEarlyVotingAction: "Начать досрочное голосование", gmEarlyVotingHint: "До третьего раунда голосование является досрочным и необязательным.", gmVotingRevealRequirementHint: "Голосование можно начать после выполнения требования раскрытия.", gmConfirmEarlyVoting: "Начать досрочное голосование? Оно не является обязательным.", gmConfirmVoting: "Начать голосование?", gmVotingUnavailable: "Голосование сейчас недоступно."
	, revealCreditsLabel: "Кредитов раскрытия", revealRequirementSatisfiedByCredit: "Требование этого раунда выполнено кредитом", revealCreditsAdded: "Начислено кредитов раскрытия: {count}", revealRequirementCompletedByForcedReveal: "Принудительное раскрытие выполнило требование этого раунда.", revealCreditConsumed: "Кредит раскрытия использован для требования нового раунда.", gmRevealCompleted: "Выполнено", gmRevealCompletedByCredit: "Выполнено кредитом", gmRevealPending: "Ожидается раскрытие"
	, gmRevealCreditTools: "Тестовые кредиты раскрытия", gmRevealCreditToolsHint: "Явная developer-команда; каждое изменение попадает в audit и snapshot.", gmAddRevealCredit: "Добавить 1 кредит", gmRemoveRevealCredit: "Снять 1 кредит", gmRevealCreditAdjusted: "Кредиты раскрытия обновлены."
	, catalogPickerKicker: "Runtime-каталог", catalogPickerTitle: "Заменить значение", catalogPickerCategory: "Категория", catalogPickerSearch: "Поиск", catalogPickerAction: "Действие", catalogPickerResults: "Каталог", catalogPickerPreview: "Предпросмотр", catalogPickerSeverity: "Тяжесть", catalogPickerAdvanced: "Расширенные операции", catalogPickerOperation: "Операция", catalogPickerTargetPlayer: "Второй игрок", catalogPickerPreviewAction: "Проверить", catalogPickerApplyOperation: "Применить операцию", catalogPickerApply: "Применить", catalogPickerLoading: "Загрузка…", catalogPickerEmpty: "Записи не найдены", catalogPickerError: "Не удалось выполнить операцию с каталогом", catalogPickerDangerConfirm: "Применить опасную операцию?"
	, catalogActionReplace: "Заменить", catalogActionAdd: "Добавить", catalogActionRemove: "Удалить", catalogActionIssue: "Выдать", catalogActionMarkUsed: "Отметить использованной", catalogActionRestoreUsed: "Восстановить карту", catalogOperationExchange: "Обменять", catalogOperationCopy: "Скопировать", catalogOperationTransfer: "Передать", catalogOperationSteal: "Украсть", catalogOperationOppositeSex: "Изменить пол на противоположный"
	, gmPanelTitle: "Панель ведущего", gmClosePanel: "Закрыть панель ведущего", gmPrimaryActionLabel: "Рекомендуемое действие", gmPanelLoading: "Загрузка панели ведущего…", gmRetry: "Повторить", gmVotingAvailabilityHint: "Доступность голосования определяется текущим состоянием игры.", gmScenarioSituations: "Сценарные ситуации", gmSkipPendingChoice: "Пропустить текущий выбор", gmScenarioPrivacyHint: "Приватный владелец карты не показывается обычному ведущему."
	, gmPanelConnectionUnavailable: "Соединение с сервером ещё не готово.", gmPanelRoomNotJoined: "Сначала присоединитесь к комнате.", gmPanelRoomNotFound: "Текущая комната не найдена.", gmPanelAccessDenied: "Нет доступа к панели ведущего.", gmPanelStateFailed: "Сервер не смог подготовить состояние панели.", gmPanelLoadFailed: "Не удалось загрузить состояние панели.", gmPanelSyncFailed: "Не удалось синхронизировать"
	, gmDiceResult: "Выпало: {value}", gmDiceAlreadyRolled: "Кубик в этом раунде уже брошен", gmDiceUnavailable: "Кубик доступен после открытия характеристик всеми активными игроками", gmDiceFeedResult: "{player} бросил кубик в раунде {round}: {value}", gmPlayerSecondaryActions: "Дополнительные действия", gmResyncPlayer: "Синхронизировать игрока", gmInspectConnection: "Проверить connection", gmTransferHost: "Передать роль ведущего", gmHostTransferConfirm: "Передать роль ведущего?", gmHostTransferIneligible: "Этот игрок не может стать ведущим", gmHostTransferRestoreWarning: "Обычное восстановление комнаты не возвращает предыдущего ведущего.", gmHideCharacteristic: "Скрыть открытую характеристику", gmHide: "Скрыть", gmDangerousActions: "Опасные действия", gmKickPlayer: "Исключить из комнаты"
	...
	, gmQuickEvent: "Быстрое событие", gmSendEvent: "Отправить событие", gmEventTextPlaceholder: "Текст события…", gmEventTextRequired: "Введите текст события.", gmEventSendFailed: "Не удалось отправить событие.", gmEventTypeInfo: "Информация", gmEventTypeWarning: "Предупреждение", gmEventTypeDanger: "Опасность", gmEventTypeSuccess: "Позитив", gmEventTypeCatastrophe: "Катастрофа"
	, gmEventTemplateEarthquake: "Землетрясение", gmEventTemplateInfection: "Заражение", gmEventTemplateSurvivors: "Выжившие", gmEventTemplateGenerator: "Генератор", gmEventTemplateEarthquakeText: "Землетрясение! Часть бункера повреждена.", gmEventTemplateInfectionText: "Угроза заражения! Нужна дезинфекция.", gmEventTemplateSurvivorsText: "Выжившие снаружи просят помощи.", gmEventTemplateGeneratorText: "Генератор сломался! Электричества нет."
	, gmActiveThreat: "Активная угроза", gmThreatNone: "Активная угроза отсутствует", gmThreatManage: "Управлять угрозой", gmThreatOperations: "Угроза", gmThreatSearch: "Поиск угрозы…", gmThreatSelect: "Выбрать конкретную угрозу", gmThreatGenerateRare: "Создать случайную редкую угрозу", gmThreatGenerateText: "Создать обычную текстовую угрозу"
	, gmResourceMonths: "Месяцы ресурса", gmAddFood: "+ Еда", gmRemoveFood: "− Еда", gmAddWater: "+ Вода", gmRemoveWater: "− Вода", gmBunkerConditions: "Условия бункера", gmApocalypseOperations: "Апокалипсис", gmRegenerateBunker: "Новый бункер", gmRegenerateApocalypse: "Новый апокалипсис", gmRegenerateBunkerConfirm: "Сгенерировать новый бункер из канонического каталога?", gmRegenerateApocalypseConfirm: "Сгенерировать новый апокалипсис из канонического каталога?"
...
Object.assign(uiTranslations.uk, {
	globalCatalogTitle: "Редактор контенту", globalCatalogDevelopmentWarning: "Лише Development: редактор джерельного контенту. У Production доступ вимкнено.",
	globalCatalogReadOnly: "Запис у каталог вимагає серверного дозволу. Непідтримувані схеми залишаються тільки для читання.", globalCatalogCategory: "Категорія", globalCatalogSearch: "Пошук",
	...
	, globalEditorScope: "Область змін", globalScopeCatalogOnly: "Лише каталог", globalScopeRoomOnly: "Лише поточна гра — використайте runtime picker", globalScopeCatalogAndRoom: "Каталог і поточна гра — не підтримується", globalEditorLanguage: "Мова", globalLanguageAll: "Усі доступні", globalEditorReadOnly: "тільки читання"
	, globalHistoryTitle: "Історія змін контенту", globalHistoryRefresh: "Оновити історію"
...
Object.assign(uiTranslations.en, {
	globalCatalogTitle: "Content Editor", globalCatalogDevelopmentWarning: "Development only: source content editor. Production access is disabled.",
	globalCatalogReadOnly: "Catalog writes require server authorization. Unsupported schemas remain read-only.", globalCatalogCategory: "Category", globalCatalogSearch: "Search",
	...
	, globalEditorScope: "Change scope", globalScopeCatalogOnly: "Catalog only", globalScopeRoomOnly: "Current game only — use the runtime picker", globalScopeCatalogAndRoom: "Catalog and current game — unsupported", globalEditorLanguage: "Language", globalLanguageAll: "All available", globalEditorReadOnly: "read-only"
	, globalHistoryTitle: "Content change history", globalHistoryRefresh: "Refresh history"
...
Object.assign(uiTranslations.ru, {
	globalCatalogTitle: "Редактор контента", globalCatalogDevelopmentWarning: "Только Development: редактор исходного контента. В Production доступ отключён.",
	globalCatalogReadOnly: "Запись в каталог требует серверного разрешения. Неподдерживаемые схемы остаются только для чтения.", globalCatalogCategory: "Категория", globalCatalogSearch: "Поиск",
	...
	, globalEditorScope: "Область изменений", globalScopeCatalogOnly: "Только каталог", globalScopeRoomOnly: "Только текущая игра — используйте runtime picker", globalScopeCatalogAndRoom: "Каталог и текущая игра — не поддерживается", globalEditorLanguage: "Язык", globalLanguageAll: "Все доступные", globalEditorReadOnly: "только чтение"
	, globalHistoryTitle: "История изменений контента", globalHistoryRefresh: "Обновить историю"
