...
(function setupStaticPageLocalization() {
    const translations = {
        uk: {
            academyCourse: "Курс",
            academyInstitution: "Навчальний заклад",
            academyStudentCount: "Кількість студентів",
            academyStudents: "Студенти",
            academySubjects: "Предмети",
            academyDetails: "Детальніше",
            academyBack: "До академічної групи",
            academyBackStudents: "До списку студентів",
            academyBackSubjects: "До списку предметів",
            academyFirstName: "Ім'я",
            academyLastName: "Прізвище",
            academyAge: "Вік",
            academyAbout: "Інтереси",
            academyTeacher: "Викладач",
            academySubjectDescription: "Опис",
            academyHours: "Навчальні години",
            academyDescription: "Навчальна група, яка вивчає C#, ASP.NET Core MVC, SignalR, SQL, Git та тестування на прикладі проєкту Bunker.",
            academyStudent1About: "Вивчає C#, ASP.NET Core та розробку програмного забезпечення.",
            academyStudent2About: "Цікавиться базами даних та SQL.",
            academyStudent3About: "Вивчає тестування програмного забезпечення.",
            academyStudent4About: "Цікавиться Git та командною розробкою.",
            academySubject1Description: "Основи C#, класи, інтерфейси та колекції.",
            academySubject2Description: "Контролери, маршрути, Razor Views та Dependency Injection.",
            academySubject3Description: "Обмін повідомленнями в реальному часі.",
            academySubject4Description: "Реляційні бази даних та SQL-запити.",
            academySubject5Description: "Контроль версій та командна робота.",
            academySubject6Description: "Модульні та інтеграційні тести.",
            navHome: "Головна",
            navPlay: "Грати",
            navRules: "Правила",
            navAuthor: "Автор",
			...
			profileLeftEarly: "Покинуто достроково",
			profileGameAbandoned: "Партію перервано",
            profileHost: "Хост",
        ...
        en: {
            ...
            academyInstitution: "Institution",
            academyStudentCount: "Student count",
            academyStudents: "Students",
            academySubjects: "Subjects",
            academyDetails: "Details",
            academyBack: "Back to the group",
            academyBackStudents: "Back to students",
            academyBackSubjects: "Back to subjects",
            academyFirstName: "First name",
            academyLastName: "Last name",
            academyAge: "Age",
            academyAbout: "Interests",
            academyTeacher: "Teacher",
            academySubjectDescription: "Description",
            academyHours: "Study hours",
            academyDescription: "A study group learning C#, ASP.NET Core MVC, SignalR, SQL, Git and testing through the Bunker project.",
            academyStudent1About: "Studies C#, ASP.NET Core and software development.",
            academyStudent2About: "Interested in databases and SQL.",
            academyStudent3About: "Studies software testing.",
            academyStudent4About: "Interested in Git and collaborative development.",
            academySubject1Description: "C# fundamentals, classes, interfaces and collections.",
            academySubject2Description: "Controllers, routes, Razor Views and dependency injection.",
            academySubject3Description: "Real-time messaging.",
            academySubject4Description: "Relational databases and SQL queries.",
            academySubject5Description: "Version control and teamwork.",
            academySubject6Description: "Unit and integration tests.",
            navHome: "Home",
            navPlay: "Play",
            navRules: "Rules",
            navAuthor: "Author",
			...
			profileLeftEarly: "Left early",
			profileGameAbandoned: "Game interrupted",
            profileHost: "Host",
        ...
        ru: {
            academyCourse: "Курс",
            academyInstitution: "Учебное заведение",
            academyStudentCount: "Количество студентов",
            academyStudents: "Студенты",
            academySubjects: "Предметы",
            academyDetails: "Подробнее",
            academyBack: "К академической группе",
            academyBackStudents: "К списку студентов",
            academyBackSubjects: "К списку предметов",
            academyFirstName: "Имя",
            academyLastName: "Фамилия",
            academyAge: "Возраст",
            academyAbout: "Интересы",
            academyTeacher: "Преподаватель",
            academySubjectDescription: "Описание",
            academyHours: "Учебные часы",
            academyDescription: "Учебная группа, которая изучает C#, ASP.NET Core MVC, SignalR, SQL, Git и тестирование на примере проекта Bunker.",
            academyStudent1About: "Изучает C#, ASP.NET Core и разработку программного обеспечения.",
            academyStudent2About: "Интересуется базами данных и SQL.",
            academyStudent3About: "Изучает тестирование программного обеспечения.",
            academyStudent4About: "Интересуется Git и командной разработкой.",
            academySubject1Description: "Основы C#, классы, интерфейсы и коллекции.",
            academySubject2Description: "Контроллеры, маршруты, Razor Views и Dependency Injection.",
            academySubject3Description: "Обмен сообщениями в реальном времени.",
            academySubject4Description: "Реляционные базы данных и SQL-запросы.",
            academySubject5Description: "Контроль версий и командная работа.",
            academySubject6Description: "Модульные и интеграционные тесты.",
            navHome: "Главная",
            navPlay: "Играть",
            navRules: "Правила",
            navAuthor: "Автор",
			...
			profileLeftEarly: "Покинуто досрочно",
			profileGameAbandoned: "Партия прервана",
            profileHost: "Хост",
            profilePlayer: "Игрок",
