...
| **End round** | `_GmPanel.cshtml:143` `#endRoundBtn` onclick=`endRound()` | `game.js` → `connection.invoke('EndRound')` | `GameHub.GameMaster.cs:451` `EndRound()` | `Room.CurrentPhase`, `room.VotingReadyResponses` | `IsCallerHost()` | — |
