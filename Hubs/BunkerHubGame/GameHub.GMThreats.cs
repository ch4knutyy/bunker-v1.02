...
public partial class GameHub
{
    ...
    private Room? GetForceThreatRoom()
    {
        ...
        return room != null &&
            ...
            (_developerAuthority.CanUseHostControls(room, player) || (_activeDirectorCapability == GmCapability.UseDirectorThreatControls && IsAuthorizedDirector(player, GmCapability.UseDirectorThreatControls))) &&
